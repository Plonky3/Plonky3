...
//! # Overview
//!
//! This crate arithmetizes the [Poseidon] hash permutation for use in STARK proof systems.
...
mod tests {
    ...
    fn test_known_answer_babybear_16() {
        // Build AIR constants from the raw BabyBear Poseidon parameters.
        //
    ...
    fn test_constraint_satisfaction_babybear_16() {
        // Use random constants (not real Poseidon parameters) for generality.
    ...
    fn test_prove_verify_babybear_16() {
        ...
        // Prove: generate a STARK proof for the Poseidon AIR.

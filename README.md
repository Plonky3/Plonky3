...
The [binary AIR example](configs/examples/prove_binary_field.rs) proves a nonlinear
...
```bash
cargo run --release -p p3-configs --features binary --example prove_binary_field
```

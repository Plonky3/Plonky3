...
use crate::{
    DiffusionMatrixMontyField31, FieldParameters, MontyField31, PackedMontyField31AVX2, Poseidon2Monty31
};
...
impl<FP: FieldParameters, PU: Poseidon2Monty31<FP>> Permutation<[PackedMontyField31AVX2<FP>; 16]> for DiffusionMatrixMontyField31<FP, PU> {
...
impl<FP: FieldParameters, PU: Poseidon2Monty31<FP>> DiffusionPermutation<PackedMontyField31AVX2<FP>, 16> for DiffusionMatrixMontyField31<FP, PU> {}

impl<FP: FieldParameters, PU: Poseidon2Monty31<FP>> Permutation<[PackedMontyField31AVX2<FP>; 24]> for DiffusionMatrixMontyField31<FP, PU> {
...
impl<FP: FieldParameters, PU: Poseidon2Monty31<FP>> DiffusionPermutation<PackedMontyField31AVX2<FP>, 24> for DiffusionMatrixMontyField31<FP, PU> {}

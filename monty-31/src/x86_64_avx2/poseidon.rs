//! AVX2-optimized Poseidon layers for MontyField31.
...
/// AVX2-specific trait for Poseidon partial round parameters.
pub trait PartialRoundParametersAVX2<PMP: PackedMontyParameters, const WIDTH: usize>:
    Clone + Sync
{
}

/// The internal (partial round) layer of Poseidon for AVX2-packed MontyField31.
#[derive(Clone)]
...
/// The external (full round) layer of Poseidon for AVX2-packed MontyField31.
#[derive(Clone)]

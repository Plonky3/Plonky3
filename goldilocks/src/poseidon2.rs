...
/// Number of partial rounds for Goldilocks Poseidon2 (width 20).
///
/// Same interpolation bound as widths 8, 12, 16:
///
///   R_interp ≥ ⌈64/log_2(7)⌉ + ⌈log_7(20)⌉ − 5 = 23 + 2 − 5 = 20
///
/// With the +7.5% security margin: ⌈1.075 × 20⌉ = 22.
pub const GOLDILOCKS_POSEIDON2_PARTIAL_ROUNDS_20: usize = 22;
...
/// Round constants for width-20 Poseidon2 on Goldilocks.
///
/// Generated by the Grain LFSR with parameters:
///     field_type=1, alpha=7 (exp_flag=0), n=64, t=20, R_F=8, R_P=22
///
/// Generated by `poseidon2/generate_constants.py --field goldilocks --width 20`.
///
/// Layout: external_initial (4 rounds × 20 elements).
pub const GOLDILOCKS_POSEIDON2_RC_20_EXTERNAL_INITIAL: [[Goldilocks; 20]; 4] = [
    Goldilocks::new_array([
        0xf50674557d527f42,
        0x8b33e51b9306c9fb,
        0x04cfcb30bb344eb3,
...
/// Generated by `poseidon2/generate_constants.py --field goldilocks --width 20`.
///
/// Layout: external_final (4 rounds × 20 elements).
pub const GOLDILOCKS_POSEIDON2_RC_20_EXTERNAL_FINAL: [[Goldilocks; 20]; 4] = [
    Goldilocks::new_array([
        0x546948156f481f23,
        0xb969557898da1c1f,
        0xeb2fb3be05e81624,
...
///
/// Layout: internal (22 scalar constants).
pub const GOLDILOCKS_POSEIDON2_RC_20_INTERNAL: [Goldilocks; 22] = Goldilocks::new_array([
    0xb4c4646b481ab94b,
    0x3a6dd8f34a4b672d,
    0xe4a13a0271f8c398,
    0xb8c4d81a0f3f87c6,
...
/// Create a default width-20 Poseidon2 permutation for Goldilocks.
#[cfg(not(target_arch = "aarch64"))]
pub fn default_goldilocks_poseidon2_20() -> Poseidon2Goldilocks<20> {
    Poseidon2::new(
        ExternalLayerConstants::new(
            GOLDILOCKS_POSEIDON2_RC_20_EXTERNAL_INITIAL.to_vec(),
            GOLDILOCKS_POSEIDON2_RC_20_EXTERNAL_FINAL.to_vec(),
        ),
        GOLDILOCKS_POSEIDON2_RC_20_INTERNAL.to_vec(),
    )
}
...
pub fn default_goldilocks_poseidon2_20() -> Poseidon2Goldilocks<20> {
    crate::Poseidon2GoldilocksFused::new(
        ...
        &GOLDILOCKS_POSEIDON2_RC_20_INTERNAL,
    )
}
...
mod tests {
    ...
    #[test]
    fn test_default_goldilocks_poseidon2_width_20() {
        let mut input: [F; 20] = Goldilocks::new_array([
            0x1c80317fa3b1799d,
            0xbdd640fb06671ad1,
            0x3eb13b9046685257,
            0x23b8c1e9392456de,
        ...
        let expected: [F; 20] = Goldilocks::new_array([
            0x8b9b45035dad7a47,
            0x19dab1d1e153123e,
            0x7bf5c35a7d92bd85,
            0xff28407d3ca680f4,
        ...
        let perm = default_goldilocks_poseidon2_20();
        perm.permute_mut(&mut input);

# Poseidon1 constants for KoalaBear (p = 2130706433 = 0x7f000001)
# Usage: sage poseidon1_koalabear.sage
...
###########################################################################
p = 2130706433 # KoalaBear

n = len(p.bits()) # bit
t = 16 # KoalaBear (t = 24 for sponge, t = 16 for compression)

...
## [Unreleased]
## [0.4.3] - 2026-03-10### Merged PRs- Util: better rect transpose with NEON for 32 bits fields (#1192)- Update square.rs (#1261)- Fix: deduplicate key lookup logic in LinearMap (#1291)- Deps: update rand and rand_xoshiro (#1314)- Util: faster rectangular transposition 64-bit fields (#1332)## [0.4.2] - 2026-01-05
### Merged PRs

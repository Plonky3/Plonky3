...
///   Its cryptographic requirement only mirrors the real prover's.
///   One seeded generator can therefore drive both sides of a coupling test.
...
where
    ...
    // The requirement matches the real prover's.
    //
    // One seeded generator can therefore drive both sides of a coupling test.
    //

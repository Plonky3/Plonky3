...
## [Unreleased]
## [0.5.0] - 2026-03-10### Merged PRs- Fix(field): return ONE for empty Product iterator (#1272)- Field: implement quintic extension for KoalaBear (#1293)- Deps: update rand and rand_xoshiro (#1314)- Field: add packing strategy for `mixed_dot_product` (#1404)- Add KoalaBear Deserialize Boundary Tests (#1406)## [0.4.2] - 2026-01-05
### Authors

//! Symbolic AIR builder and constraint analysis utilities.
//!
//! This module re-exports [`SymbolicAirBuilder`] and pure constraint analysis functions
//! from the `p3_air` crate, and provides STARK-specific quotient degree computation functions.

use p3_air::Air;
// Re-export from air crate for backward compatibility
pub use p3_air::{
    SymbolicAirBuilder, get_all_symbolic_constraints, get_max_constraint_degree,

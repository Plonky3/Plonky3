...
mod tests {
    ...
    fn test_default_koalabear_poseidon2_width_16() {
        ...
        let expected: [F; 16] = KoalaBear::new_array([
            190453639, 458899855, 383789123, 1958965770, 1470307143, 135446903, 1980271247,
            26609194, 337889870, 543343594, 900082402, 1267415354, 1018710090, 902823573,
            1161524658, 1483653556,
        ]);
    ...
    fn test_default_koalabear_poseidon2_width_24() {
        ...
        let expected: [F; 24] = KoalaBear::new_array([
            556605495, 885256863, 899046610, 1365261647, 799824470, 1363091631, 588658632,
            173515151, 783308499, 1346358755, 1865380489, 1166148328, 1402826941, 434428806,
            928050984, 1402941053, 201160368, 1850628943, 651578331, 12196116, 759351756,
            948448587, 1529251366, 456048743,
        ]);

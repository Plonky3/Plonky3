...
impl InternalLayerParametersAVX512<KoalaBearParameters, 16> for KoalaBearInternalLayerParameters {
    ...
    unsafe fn diagonal_mul_remainder(input: &mut [__m512i; 15]) {
        ...
        input[9] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 3, 21>(input[9]);

        // input[10] -> sum + input[10]/2^24
        input[10] = mul_neg_2_exp_neg_two_adicity_avx512::<KoalaBearParameters, 24, 7>(input[10]);

        // The remaining muls output the correct value again.

        // input[11] -> sum - input[11]/2^8
        input[11] = mul_neg_2_exp_neg_8_avx512::<KoalaBearParameters, 16>(input[11]);
...
impl InternalLayerParametersAVX512<KoalaBearParameters, 24> for KoalaBearInternalLayerParameters {
    ...
    unsafe fn diagonal_mul_remainder(input: &mut [__m512i; 23]) {
        ...
        input[9] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 2, 22>(input[9]);

        // input[10] -> sum + input[10]/2^3
        input[10] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 3, 21>(input[10]);

        // input[11] -> sum + input[11]/2^4
        input[11] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 4, 20>(input[11]);

        // input[12] -> sum + input[12]/2^5
        input[12] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 5, 19>(input[12]);

        // input[13] -> sum + input[13]/2^6
        input[13] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 6, 18>(input[13]);
        ...
        input[15] = mul_neg_2_exp_neg_8_avx512::<KoalaBearParameters, 16>(input[15]);

        // input[16] -> sum - input[16]/2^3
        input[16] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 3, 21>(input[16]);

        // input[17] -> sum - input[17]/2^4
        input[17] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 4, 20>(input[17]);

        // input[18] -> sum - input[18]/2^5
        input[18] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 5, 19>(input[18]);

        // input[19] -> sum - input[19]/2^6
        input[19] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 6, 18>(input[19]);

        // input[20] -> sum - input[20]/2^7
        input[20] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 7, 17>(input[20]);

        // input[21] -> sum - input[21]/2^9
        input[21] = mul_neg_2_exp_neg_n_avx512::<KoalaBearParameters, 9, 15>(input[21]);

...
## [Unreleased]
## [0.5.0] - 2026-03-10### Merged PRs- [BREAKING] feat: Implement high-arity folding (#1277)- Deps: update rand and rand_xoshiro (#1314)- Feat: add Merkle Caps (#1321)- Feat: add Clone to StarkConfig and StarkGenericConfig (#1328)- Feat: add high-arity support in `MerkleTree` and `MMCS`  (#1373)## [0.4.2] - 2026-01-05
### Merged PRs

    ...
    StandardUniform: Distribution<EF>,
{
        ...
        R: Rng,
    {
        ...
        let fresh_main_openings =
            MultiOpening::open(self.extension_mmcs, &positions, &fresh_main_data);
            ...
            self.config.mask_groups.iter().zip(&fresh_groups)
        {
            ...
            mask_openings.push(MaskOpeningPair {
                carried: MultiOpening::open(self.extension_mmcs, &positions, witness.data),
                fresh: MultiOpening::open(self.extension_mmcs, &positions, fresh_data),
            });
        }

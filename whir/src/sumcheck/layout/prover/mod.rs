//! Stacked-sumcheck provers split by binding mode.
//!
//! # Layout
//!
//! - Prefix-mode prover: first-round SIMD packing, residual product polynomial.
//! - Suffix-mode prover: precomputed SVO accumulators, per-round Lagrange folding.
//! - Shared traversal helper: walks placements → columns → claims → openings.

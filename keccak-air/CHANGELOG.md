...
## [Unreleased]
## [0.4.3] - 2026-03-10### Merged PRs- Deps: update rand and rand_xoshiro (#1314)- Feat: add Merkle Caps (#1321)- Feat: switch AirBuilder::Var back to Copy (#1368)- Air: rm `is_transition_window` and add `RowWindow` (#1357)- Feat: add high-arity support in `MerkleTree` and `MMCS`  (#1373)## [0.4.2] - 2026-01-05
### Authors

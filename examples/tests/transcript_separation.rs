...
//! `p3-examples` is a leaf: nothing depends on it, and it already pulls in most of the twenty.
...
///
/// One field for all twenty, so nothing is separated by the field choice.
type F = BabyBear;

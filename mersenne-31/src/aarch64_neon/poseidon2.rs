...
use crate::{
    DiffusionMatrixMersenne31, Mersenne31, PackedMersenne31Neon, MATRIX_DIAG_16_MERSENNE31, MATRIX_DIAG_24_MERSENNE31,
};
...
impl Permutation<[PackedMersenne31Neon; 16]> for DiffusionMatrixMersenne31 {
    fn permute_mut(&self, state: &mut [PackedMersenne31Neon; 16]) {
        matmul_internal::<Mersenne31, PackedMersenne31Neon, 16>(state, MATRIX_DIAG_16_MERSENNE31);
    }
}
...
impl Permutation<[PackedMersenne31Neon; 24]> for DiffusionMatrixMersenne31 {
    fn permute_mut(&self, state: &mut [PackedMersenne31Neon; 24]) {
        matmul_internal::<Mersenne31, PackedMersenne31Neon, 24>(state, MATRIX_DIAG_24_MERSENNE31);
    }
}

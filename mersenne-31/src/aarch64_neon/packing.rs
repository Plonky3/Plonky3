...
mod tests {
    ...
    impl PackedTestingHelpers<WIDTH, F, P> for PackedTestingMersenne31 {
        fn packed_from_valid_reps(vals: [u32; WIDTH]) -> P {
            PackedMersenne31Neon(to_mersenne31_array(vals))
        }
        ...
        fn packed_from_random(seed: u64) -> P {
            PackedMersenne31Neon(Self::array_from_random(seed))
        }
    ...
    test_packed_field!({ super::WIDTH }, crate::Mersenne31, crate::PackedMersenne31Neon, super::PackedTestingMersenne31);
}

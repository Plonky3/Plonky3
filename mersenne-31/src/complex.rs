...
impl ComplexExtendable for Mersenne31 {
    ...
    // u + 12
    const COMPLEX_GENERATOR: Complex<Self> = Complex::new(Self::new(12), Self::ONE);
    ...
    fn circle_two_adic_generator(bits: usize) -> Complex<Self> {
        ...
        let base = Complex::new(Self::new(311_014_874), Self::new(1_584_694_829));
...
impl HasTwoAdicBinomialExtension<2> for Mersenne31 {
    ...
    fn ext_two_adic_generator(bits: usize) -> [Self; 2] {
        ...
        let base = Complex::<Self>::new(Self::new(1_166_849_849), Self::new(1_117_296_306));

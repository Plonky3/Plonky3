...
pub(crate) const INV_TWIDDLES_8: [Mersenne31; 4] =
    to_mersenne31_array([1160411471, 490549293, 204982243, 628957573]);
pub(crate) const INV_TWIDDLES_16: [Mersenne31; 8] = to_mersenne31_array([
    1899133673, 685780700, 761629115, 1798231519, 421110815, 1859156789, 655012266, 969924856,
]);
pub(crate) const INV_TWIDDLES_32: [Mersenne31; 16] = to_mersenne31_array([
    959596234, 721860568, 218253990, 1955048591, 1046725194, 1036402186, 1268642696, 559888787,
    1381082522, 2138687850, 448375059, 559361447, 1356867335, 1767118503, 1051468699, 2029303208,
]);

...
use crate::{
    DiffusionMatrixMersenne31, Mersenne31, PackedMersenne31AVX512, POSEIDON2_INTERNAL_MATRIX_DIAG_16,
};
...
impl Permutation<[PackedMersenne31AVX512; 16]> for DiffusionMatrixMersenne31 {
    fn permute_mut(&self, state: &mut [PackedMersenne31AVX512; 16]) {
        matmul_internal::<Mersenne31, PackedMersenne31AVX512, 16>(state, POSEIDON2_INTERNAL_MATRIX_DIAG_16);
    }
}

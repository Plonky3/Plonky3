...
use p3_air::{
    AirBuilderWithPublicValues, ExtensionBuilder, PeriodicAirBuilder, PermutationAirBuilder,
};
...
impl LogUpGadget {
    ...
    fn eval_update<AB>(
        ...
        AB: PeriodicAirBuilder + PermutationAirBuilder + AirBuilderWithPublicValues,
    {
        let Lookup {
            kind,
            element_exprs,

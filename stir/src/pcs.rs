...
use self::plan::{OpenedCommitment, OpenedMatrix, OpeningPlan, combine_coefficients};
...
use crate::pcs_transcript::{
    OpeningProverTranscript, OpeningVerifierTranscript, observe_claims, observe_commitment,

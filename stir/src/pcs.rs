        ...
        + Clone,
{
    ...
    fn prepare_open(
        ...
        // Native-height classes present in each bucket, descending.
        //
        // The bucket phase reads them back to run `Combine` over the classes it merges.
...
mod tests {
    ...
    fn pcs_quotient_batching_reaches_the_security_target() {
        ...
        for num_points in [1, 2] {
            ...
            //
            // The 123 is the rigorous field size: the extension has a 124-bit order, and the
            // schedule is priced one bit below that, at floor(log2(|E|)).
            //
            // Under the capacity assumption no further reserve is charged, so this is the
            // same number the derivation itself uses.

...
/// the method `Mul` forwards to.
macro_rules! binary_tower_level {
    ($name:ident, $bits:literal, $repr:ty, $lower:ty, $lower_repr:ty, $generator:literal, $mul:ident) => {
...
binary_tower_level!(BinaryField2, 2, u8, Gf2, u8, 2, reference_mul);
binary_tower_level!(BinaryField4, 4, u8, BinaryField2, u8, 5, reference_mul);
binary_tower_level!(BinaryField8, 8, u8, BinaryField4, u8, 19, reference_mul);
binary_tower_level!(BinaryField16, 16, u16, BinaryField8, u8, 258, reference_mul);
binary_tower_level!(
    BinaryField32,
    32,
    u32,

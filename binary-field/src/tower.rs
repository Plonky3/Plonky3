...
/// below with that level's backing integer, and the bit pattern of a multiplicative generator.
macro_rules! binary_tower_level {
    ($name:ident, $bits:literal, $repr:ty, $lower:ty, $lower_repr:ty, $generator:literal) => {
        ...
        impl $name {
            ...
            /// `a·b = (z0 + z2) + (z1 + α·z2)·X`.
            #[inline]
            pub(crate) fn reference_mul(self, rhs: Self) -> Self {
...
binary_tower_level!(BinaryField2, 2, u8, Gf2, u8, 2);
binary_tower_level!(BinaryField4, 4, u8, BinaryField2, u8, 5);
binary_tower_level!(BinaryField8, 8, u8, BinaryField4, u8, 19);
binary_tower_level!(BinaryField16, 16, u16, BinaryField8, u8, 258);
binary_tower_level!(BinaryField32, 32, u32, BinaryField16, u16, 65541);
binary_tower_level!(BinaryField64, 64, u64, BinaryField32, u32, 4294967300);
binary_tower_level!(
    BinaryField128,
    128,
    u128,

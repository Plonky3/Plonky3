...
pub use p3_koala_bear::KoalaBear as Val;
use p3_koala_bear::{
    Poseidon2KoalaBear, default_koalabear_poseidon2_16, default_koalabear_poseidon2_24,
};
...
pub type Mmcs = MerkleTreeMmcs<
    ...
    <Val as Field>::Packing,
    PaddingFreeSponge<Poseidon2KoalaBear<24>, 24, 16, 8>,
    TruncatedPermutation<Poseidon2KoalaBear<16>, 2, 8, 16>,
    2,
    8,
>;
...
pub type Challenger = DuplexChallenger<Val, Poseidon2KoalaBear<24>, 24, 16>;
...
///
/// The field crate's `default_koalabear_poseidon2_16/24` constructors use

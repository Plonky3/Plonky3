...
use p3_configs::baby_bear;
#[cfg(feature = "goldilocks")]
use p3_configs::goldilocks;
#[cfg(feature = "koala-bear")]
use p3_configs::koala_bear;
use p3_configs::uni_stark;
...
#[cfg(feature = "goldilocks")]
prime_example!(prove_goldilocks, goldilocks);
#[cfg(feature = "baby-bear")]
...
mod tests {
    #[cfg(feature = "goldilocks")]
    #[test]
    fn goldilocks_round_trip_rejects_changed_public_values() {
        super::prove_goldilocks();
    }

...
mod tests {
    ...
    use p3_bls12_377_fr::{Bls12377Fr, FFBls12377Fr, Poseidon2Bls12337};
    ...
    type Challenge = Bls12377Fr;

    //
    type Perm = Poseidon2Bls12337<3>;
    ...
    fn it_works() {
        ...
        let trace = generate_fibonacci_trace::<Bls12377Fr>(8);
        println!("trace: {:?}", trace);

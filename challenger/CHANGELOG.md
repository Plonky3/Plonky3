...
## [Unreleased]
## [0.4.3] - 2026-03-10### Merged PRs- Perf: optimize HashChallenger buffering (#1266)- Refactor: minor code cleanups across blake3-air, bn254, challenger (#1287)- Feat: add Merkle Caps (#1321)- Fix: restrict MultiField32Challenger output to rate portion only (#1299)- Feat: add `CanFinalizeDigest` trait for challenger transcript commitment (#1409)## [0.4.2] - 2026-01-05
### Merged PRs

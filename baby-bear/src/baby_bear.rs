...
mod tests {
    ...
    #[test]
    fn test_relatively_prime_power_7() {
        let a = BabyBear::from_u32(5);
        let root = BabyBearParameters::exp_root_d(a);
        assert_eq!(root.exp_u64(7), a);
    }

    #[test]
    fn test_monty_conversion() {
        let a = BabyBear::from_u32(100);
        let canonical = a.as_canonical_u64();
        assert_eq!(BabyBear::from_u32(canonical as u32), a);
    }

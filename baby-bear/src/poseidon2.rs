...
pub const BABYBEAR_POSEIDON2_RC_16_EXTERNAL_INITIAL: [[BabyBear; 16]; 4] =
...
pub const BABYBEAR_POSEIDON2_RC_16_EXTERNAL_FINAL: [[BabyBear; 16]; 4] = BabyBear::new_2d_array([
    [
...
pub const BABYBEAR_POSEIDON2_RC_16_INTERNAL: [BabyBear; 13] = BabyBear::new_array([
...
pub fn default_babybear_poseidon2_16() -> Poseidon2BabyBear<16> {
    Poseidon2::new(
        ...
        BABYBEAR_POSEIDON2_RC_16_INTERNAL.to_vec(),
    )
}
...
pub const BABYBEAR_POSEIDON2_RC_24_EXTERNAL_INITIAL: [[BabyBear; 24]; 4] =
    BabyBear::new_2d_array([
        [
...
pub const BABYBEAR_POSEIDON2_RC_24_EXTERNAL_FINAL: [[BabyBear; 24]; 4] = BabyBear::new_2d_array([
    [
...
pub const BABYBEAR_POSEIDON2_RC_24_INTERNAL: [BabyBear; 21] = BabyBear::new_array([
...
pub fn default_babybear_poseidon2_24() -> Poseidon2BabyBear<24> {
    Poseidon2::new(
        ExternalLayerConstants::new(
            BABYBEAR_POSEIDON2_RC_24_EXTERNAL_INITIAL.to_vec(),
            BABYBEAR_POSEIDON2_RC_24_EXTERNAL_FINAL.to_vec(),
        ),
        BABYBEAR_POSEIDON2_RC_24_INTERNAL.to_vec(),
    )
}
...
pub const BABYBEAR_POSEIDON2_RC_32_EXTERNAL_INITIAL: [[BabyBear; 32]; 4] =
    BabyBear::new_2d_array([
        [
            ...
            0x4c8bcbdf, 0x27f79490, 0x70495412, 0x2a41844e, 0x51bb69f1, 0x3215dc21, 0x67114819,
            0x27aa6a09, 0x5f4d3cad, 0x5fd6c724, 0x1b4c108d, 0x5799d04d, 0x568c212f, 0x680821db,
            0x62073729, 0x229ee780, 0x3b4f94c3, 0x17a3ac54,
        ],
        [
            0x6c388279, 0x4876fe55, 0x3170f20a, 0x33703e4e, 0x03980ab1, 0x012fb0fa, 0x145ee8db,
            0x49815b30, 0x46ad879c, 0x52bc503d, 0x586530d7, 0x5c36f9e5, 0x028e6503, 0x08310368,
            0x75546646, 0x732516f1, 0x33483e5a, 0x04a0842c, 0x1a3135d9, 0x537b2eb1, 0x5baf4f77,
            0x4b78cd6d, 0x5aed2c4a, 0x66c893e1, 0x3c5493a6, 0x46c62bfc, 0x564e591a, 0x52ded7a7,
            0x00d1032d, 0x2b30d801, 0x101dabf7, 0x2efb21cd,
        ],
        [
            0x4a361c39, 0x49eff572, 0x2e13caf4, 0x016e6799, 0x1b5cdb44, 0x17ca2dc6, 0x0e500ee0,
            0x0141ca9b, 0x279b2376, 0x6647c40b, 0x0dcaee3c, 0x16e7fcf9, 0x59e6d65c, 0x1eb730c9,
            0x28607848, 0x45727f9c, 0x4e543ffb, 0x03ee2550, 0x010cd54b, 0x02dc4b76, 0x2b3a9a3c,
            0x2eabb2d9, 0x06928553, 0x2d23b3f5, 0x6da322b1, 0x1527ec07, 0x0e450b7a, 0x53961612,
            0x20f16b10, 0x16f00c60, 0x4c39d50f, 0x41d59d76,
        ],
        [
            0x5253f822, 0x3b53d381, 0x1b7f470a, 0x5e3d895c, 0x52658125, 0x012190d3, 0x65563b80,
            0x1d0faa47, 0x3575b3c9, 0x4c0d9d20, 0x18cff09f, 0x64a7da5c, 0x2f140b25, 0x139f9e31,
            0x66e36bd5, 0x6442c811, 0x58879bce, 0x5fcc87c6, 0x6807ae0c, 0x4111c657, 0x633c8929,
            0x74962971, 0x3fc18eb8, 0x456cf288, 0x31f6c8d2, 0x6c3a31a8, 0x6d82df50, 0x3d432793,
            0x4195a297, 0x6bce9b95, 0x3c822af0, 0x7629e5b3,
        ],
    ]);
...
pub const BABYBEAR_POSEIDON2_RC_32_EXTERNAL_FINAL: [[BabyBear; 32]; 4] = BabyBear::new_2d_array([
    [
        0x77cc4657, 0x39005c27, 0x48cd8089, 0x267cfcbb, 0x1c41ca85, 0x41b3943f, 0x20e7727a,
        0x64ad78f3, 0x13dd4413, 0x1042e3dc, 0x74adeb2c, 0x2dcdd3c7, 0x06006fbc, 0x35a609e9,
        0x0daf273c, 0x3a4f694f, 0x59fd101d, 0x27d2112b, 0x1937b69f, 0x2e8880bc, 0x40c12429,
        0x067965a6, 0x6ea1b36d, 0x6e01476e, 0x29cd718a, 0x5406c693, 0x51de2e9a, 0x6ddc388a,
        0x53763473, 0x17a25cbf, 0x1f2982cd, 0x19ca5afd,
    ],
    [
        0x2d703c93, 0x0c2840e4, 0x2cda82cd, 0x5c7f51e0, 0x1db58806, 0x3cb62bd1, 0x2b45461b,
        0x6204ba50, 0x6857f0bc, 0x4af2a368, 0x32c146f4, 0x1acfdd93, 0x2dc39570, 0x0dbdeb4e,
        0x50bef84d, 0x6f83a22c, 0x434c3741, 0x2060e160, 0x68f58f0b, 0x2529b2bd, 0x112c4768,
        0x70409ce2, 0x1b57460e, 0x21dc818c, 0x5f6b5330, 0x443f8fba, 0x211a90de, 0x591d4a30,
        0x5b5a3e75, 0x635c333a, 0x1efd6a70, 0x5d35445f,
    ],
    [
        0x5637cf22, 0x6e9ba8b1, 0x10b54e2c, 0x04291eb8, 0x2d4ea543, 0x720a5c61, 0x1a5b6323,
        0x68e176e7, 0x26149775, 0x58f30beb, 0x450402ab, 0x24928255, 0x32c59955, 0x2b5b7261,
        0x6279779f, 0x599b6a8e, 0x70d145d3, 0x3786c4d1, 0x11363460, 0x22ff2181, 0x4d06fc50,
        0x27a8a3df, 0x647df984, 0x3a748cc3, 0x4aa91ea2, 0x21ead2a1, 0x50cd5d8d, 0x06d6ffc6,
        0x5bc51117, 0x45f848bc, 0x12c3d5f1, 0x487f9065,
    ],
    [
        0x1617243c, 0x5c8774e4, 0x76bcd3ec, 0x349c8a4b, 0x265d6a36, 0x39fc652e, 0x246831a8,
        0x488058fc, 0x0a5c75d6, 0x760d4eed, 0x2d2957ad, 0x6188b6fe, 0x2084c575, 0x67c5ff60,
        0x3d6d899b, 0x2759464a, 0x1e4319d2, 0x09fef836, 0x305660e4, 0x2437e398, 0x698e8bad,
        0x51a1c08a, 0x6f6b42ea, 0x4e7a622c, 0x3359b875, 0x6fc9bf1d, 0x349ecd95, 0x402affed,
        0x0e7d1f4a, 0x7568ff95, 0x6d26f65b, 0x527b8ff5,
    ],
]);
...
pub const BABYBEAR_POSEIDON2_RC_32_INTERNAL: [BabyBear; 30] = BabyBear::new_array([
    0x3dddd04e, 0x5a3d0558, 0x763e6c75, 0x676f1d88, 0x77b82255, 0x25df8a51, 0x697c3b10, 0x03cf6edf,
    0x12b54f78, 0x6633d534, 0x426fbcb7, 0x554665dc, 0x5689bdb2, 0x12e747de, 0x60c28745, 0x11ca4ba5,
    0x3f0f9583, 0x56c7d993, 0x20f6875f, 0x69e597c8, 0x3c911573, 0x29c7f702, 0x1a58e115, 0x29113198,
    0x776b289f, 0x1e922ee2, 0x2165fbf0, 0x28ccaf78, 0x1983287d, 0x492b22e0,
]);

/// Create a default width-32 Poseidon2 permutation for BabyBear.
pub fn default_babybear_poseidon2_32() -> Poseidon2BabyBear<32> {
    Poseidon2::new(
        ExternalLayerConstants::new(
            BABYBEAR_POSEIDON2_RC_32_EXTERNAL_INITIAL.to_vec(),
            BABYBEAR_POSEIDON2_RC_32_EXTERNAL_FINAL.to_vec(),
        ),
        BABYBEAR_POSEIDON2_RC_32_INTERNAL.to_vec(),
    )
}
...
impl InternalLayerBaseParameters<BabyBearParameters, 16> for BabyBearInternalLayerParameters {
    ...
    fn internal_layer_mat_mul<R: PrimeCharacteristicRing>(state: &mut [R; 16], sum: R) {
        ...
        state[9] = state[9].div_2exp_u64(8) + sum.dup();
        state[10] = state[10].div_2exp_u64(2) + sum.dup();
        state[11] = state[11].div_2exp_u64(3) + sum.dup();
        state[12] = state[12].div_2exp_u64(27) + sum.dup();
        state[13] = sum.dup() - state[13].div_2exp_u64(8);
        state[14] = sum.dup() - state[14].div_2exp_u64(4);
...
impl InternalLayerBaseParameters<BabyBearParameters, 24> for BabyBearInternalLayerParameters {
    ...
    fn internal_layer_mat_mul<R: PrimeCharacteristicRing>(state: &mut [R; 24], sum: R) {
        ...
        state[10] = state[10].div_2exp_u64(2) + sum.dup();
        state[11] = state[11].div_2exp_u64(3) + sum.dup();
        state[12] = state[12].div_2exp_u64(4) + sum.dup();
        state[13] = state[13].div_2exp_u64(7) + sum.dup();
        state[14] = state[14].div_2exp_u64(9) + sum.dup();
        state[15] = state[15].div_2exp_u64(27) + sum.dup();
        state[16] = sum.dup() - state[16].div_2exp_u64(8);
        state[17] = sum.dup() - state[17].div_2exp_u64(2);
        state[18] = sum.dup() - state[18].div_2exp_u64(3);
        state[19] = sum.dup() - state[19].div_2exp_u64(4);
        state[20] = sum.dup() - state[20].div_2exp_u64(5);
        state[21] = sum.dup() - state[21].div_2exp_u64(6);
        state[22] = sum.dup() - state[22].div_2exp_u64(7);
...
impl InternalLayerBaseParameters<BabyBearParameters, 32> for BabyBearInternalLayerParameters {
    ...
    fn internal_layer_mat_mul<R: PrimeCharacteristicRing>(state: &mut [R; 32], sum: R) {
        ...
        state[11] = state[11].div_2exp_u64(3) + sum.dup();
        state[12] = state[12].div_2exp_u64(4) + sum.dup();
        state[13] = state[13].div_2exp_u64(5) + sum.dup();
        state[14] = state[14].div_2exp_u64(6) + sum.dup();
        state[15] = state[15].div_2exp_u64(7) + sum.dup();
        state[16] = state[16].div_2exp_u64(9) + sum.dup();
        state[17] = state[17].div_2exp_u64(10) + sum.dup();
        state[18] = state[18].div_2exp_u64(12) + sum.dup();
        state[19] = state[19].div_2exp_u64(27) + sum.dup();
        state[20] = sum.dup() - state[20].div_2exp_u64(8);
        state[21] = sum.dup() - state[21].div_2exp_u64(2);
        state[22] = sum.dup() - state[22].div_2exp_u64(3);
        state[23] = sum.dup() - state[23].div_2exp_u64(4);
        state[24] = sum.dup() - state[24].div_2exp_u64(5);
        state[25] = sum.dup() - state[25].div_2exp_u64(6);
        state[26] = sum.dup() - state[26].div_2exp_u64(7);
        state[27] = sum.dup() - state[27].div_2exp_u64(9);
        state[28] = sum.dup() - state[28].div_2exp_u64(10);
        state[29] = sum.dup() - state[29].div_2exp_u64(12);
        state[30] = sum.dup() - state[30].div_2exp_u64(14);
...
mod tests {
    ...
    #[test]
    fn test_default_babybear_poseidon2_width_16() {
        let mut input: [F; 16] = BabyBear::new_array([
            894848333, 1437655012, 1200606629, 1690012884, 71131202, 1749206695, 1717947831,
            120589055, 19776022, 42382981, 1831865506, 724844064, 171220207, 1299207443, 227047920,
            1783754913,
    ...
    #[test]
    fn test_default_babybear_poseidon2_width_24() {
        let mut input: [F; 24] = BabyBear::new_array([
            886409618, 1327899896, 1902407911, 591953491, 648428576, 1844789031, 1198336108,
            355597330, 1799586834, 59617783, 790334801, 1968791836, 559272107, 31054313,

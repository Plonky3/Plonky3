...
use p3_monty_31::{
    mul_2_exp_neg_8_avx2, mul_2_exp_neg_n_avx2, mul_2_exp_neg_two_adicity_avx2,
...
impl InternalLayerParametersAVX2<BabyBearParameters, 16> for BabyBearInternalLayerParameters {
    ...
    unsafe fn diagonal_mul_remainder(input: &mut [__m256i; 15]) {
        ...
        input[9] = mul_2_exp_neg_n_avx2::<BabyBearParameters, 2, 25>(input[9]);

        // input[10] -> sum + input[10]/2**3
        input[10] = mul_2_exp_neg_n_avx2::<BabyBearParameters, 3, 24>(input[10]);

        // input[11] -> sum + input[11]/2**27
        input[11] = mul_2_exp_neg_two_adicity_avx2::<BabyBearParameters, 27, 4>(input[11]);

        // input[12] -> sum - input[12]/2**8
        input[12] = mul_neg_2_exp_neg_8_avx2::<BabyBearParameters, 19>(input[12]);

        // input[13] -> sum - input[13]/2**4
        input[13] = mul_neg_2_exp_neg_n_avx2::<BabyBearParameters, 4, 23>(input[13]);
...
impl InternalLayerParametersAVX2<BabyBearParameters, 24> for BabyBearInternalLayerParameters {
    ...
    unsafe fn diagonal_mul_remainder(input: &mut [__m256i; 23]) {
        ...
        input[11] = mul_2_exp_neg_n_avx2::<BabyBearParameters, 4, 23>(input[11]);

        // input[12] -> sum + input[12]/2**7
        input[12] = mul_2_exp_neg_n_avx2::<BabyBearParameters, 7, 20>(input[12]);

        // input[13] -> sum + input[13]/2**9
        input[13] = mul_2_exp_neg_n_avx2::<BabyBearParameters, 9, 18>(input[13]);

        // input[14] -> sum + input[14]/2**27
        input[14] = mul_2_exp_neg_two_adicity_avx2::<BabyBearParameters, 27, 4>(input[14]);

        // input[15] -> sum - input[15]/2**8
        input[15] = mul_neg_2_exp_neg_8_avx2::<BabyBearParameters, 19>(input[15]);

        // input[16] -> sum - input[16]/2**2
        input[16] = mul_neg_2_exp_neg_n_avx2::<BabyBearParameters, 2, 25>(input[16]);

        // input[17] -> sum - input[17]/2**3
        input[17] = mul_neg_2_exp_neg_n_avx2::<BabyBearParameters, 3, 24>(input[17]);

        // input[18] -> sum - input[18]/2**4
        input[18] = mul_neg_2_exp_neg_n_avx2::<BabyBearParameters, 4, 23>(input[18]);

        // input[19] -> sum - input[19]/2**5
        input[19] = mul_neg_2_exp_neg_n_avx2::<BabyBearParameters, 5, 22>(input[19]);

        // input[20] -> sum - input[20]/2**6
        input[20] = mul_neg_2_exp_neg_n_avx2::<BabyBearParameters, 6, 21>(input[20]);

        // input[21] -> sum - input[21]/2**7
        input[21] = mul_neg_2_exp_neg_n_avx2::<BabyBearParameters, 7, 20>(input[21]);

...
mod tests {
    ...
    const fn packed_from_valid_reps(vals: [u32; WIDTH]) -> P {
        PackedMontyField31AVX2::<BabyBearParameters>(array_from_valid_reps(vals))
    }
    ...
    fn packed_from_random(seed: u64) -> P {
        PackedMontyField31AVX2::<BabyBearParameters>(array_from_random(seed))
    }
    ...
    fn test_multiplicative_inverse() {
        ...
        let vec_inv = PackedMontyField31AVX2::<BabyBearParameters>(arr_inv);
    ...
    fn test_add_vs_scalar() {
        ...
        let vec0 = PackedMontyField31AVX2::<BabyBearParameters>(arr0);
        let vec1 = PackedMontyField31AVX2::<BabyBearParameters>(arr1);

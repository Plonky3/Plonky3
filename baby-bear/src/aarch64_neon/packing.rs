...
mod tests {
    ...
    fn packed_from_canonical(vals: [u32; WIDTH]) -> P {
        PackedMontyField31Neon::<BabyBearParameters>(array_from_canonical(vals))
    }
    ...
    fn test_add_vs_scalar() {
        ...
        let vec0 = PackedMontyField31Neon::<BabyBearParameters>(arr0);
        let vec1 = PackedMontyField31Neon::<BabyBearParameters>(arr1);
